...
const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    "role:specification": "Edital / syllabus",
    "role:evidence": "Past exam / answer key",
    "role:knowledge": "Study material",
    "role:administrative": "Administrative",
    "kind:edital": "Edital",
    "kind:prova": "Exam paper",
    "kind:gabarito": "Answer key",
    "kind:programa": "Programme",
    "kind:other": "Other",
    or: "or",
  ...
  pt: {
    ...
    "{docs} imported · {extracted} extracted · {failed} failed · {label} need a label · syllabus: {syllabus} · {prev} previous questions · {kus} KUs · {pub} published":
      "{docs} importados · {extracted} extraídos · {failed} com falha · {label} precisam de rótulo · programa: {syllabus} · {prev} questões anteriores · {kus} UCs · {pub} publicadas",
    "Last generation ({at}): {error}": "Última geração ({at}): {error}",
    "Content pipeline unavailable.": "Pipeline de conteúdo indisponível.",
    "{n} file(s) · {needs} need a label · {failed} failed · {pruned} pruned · {productive} productive":
      "{n} arquivo(s) · {needs} precisam de rótulo · {failed} com falha · {pruned} descartados · {productive} produtivos",
    "Filter files": "Filtrar arquivos",
    "Needs label": "Precisa de rótulo",
    Pruned: "Descartado",
    Productive: "Produtivo",
    "Nothing waiting for a label.": "Nada aguardando rótulo.",
    "No files match this filter.": "Nenhum arquivo corresponde a este filtro.",
    crawler: "crawler",
    "dropped at import": "descartado na importação",
    "not imported": "não importado",
    "bytes purged": "bytes removidos",
    "bytes stored": "bytes armazenados",
    "{n} section(s)": "{n} seção(ões)",
    "{n} published": "{n} publicadas",
    "{n} in review": "{n} em revisão",
    "pruned: {reason}": "descartado: {reason}",
    "syllabus: skipped ({reason})": "programa: pulado ({reason})",
    "syllabus: {n} nodes ({status})": "programa: {n} nós ({status})",
    "evidence: skipped ({reason})": "evidência: pulada ({reason})",
    "evidence: {n} previous questions": "evidência: {n} questões anteriores",
    "knowledge: skipped ({reason})": "conhecimento: pulado ({reason})",
    "knowledge: {chunks} chunks · {eligible} eligible · {parked} parked · {units} KUs":
      "conhecimento: {chunks} trechos · {eligible} elegíveis · {parked} em espera · {units} UCs",
    "auto-classify: {n}/{max} tries, last {result}":
      "autoclassificação: {n}/{max} tentativas, última {result}",
    Relabel: "Rerotular",
    "What is this file? The role decides which stage consumes it.":
      "O que é este arquivo? O papel decide qual etapa o consome.",
    "Document role": "Papel do documento",
    "Document kind": "Tipo do documento",
    "Apply label & reprocess": "Aplicar rótulo e reprocessar",
    "role:specification": "Edital / programa",
    "role:evidence": "Prova / gabarito",
    "role:knowledge": "Material de estudo",
    "role:administrative": "Administrativo",
    "kind:edital": "Edital",
    "kind:prova": "Prova",
    "kind:gabarito": "Gabarito",
    "kind:programa": "Programa",
    "kind:other": "Outro",
