// Concept: §41.5 positive ladder — POS items pass rungs 1–3.
...
const FIXTURE = resolve(process.cwd(), "fixtures/golden/positive/pos-items.json");
...
describe("§41.5 positive ladder POS-001..005", () => {
  ...
  for (const item of file.items) {
    it(`${item.id} passes structural + relevance + grounding`, () => {
